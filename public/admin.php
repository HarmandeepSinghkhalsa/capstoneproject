      ...
      if(array_key_exists("submit", $_POST)){
         ...
         if ($_POST['search'] == '1'){
          ...
          if ($_POST['delete'] == '1'){
             ...
             $query_check = "SELECT * FROM `users` WHERE `users`.`email` = '".mysqli_real_escape_string($link, $_POST['email'])."' LIMIT 1";
...
<nav class="navbar navbar-light bg-faded navbar-fixed-top">
  ...
  <a class="navbar-brand" href="#">Admin manage system</a>
	...
	<div class="pull-xs-right">
      <a href ='admin_all_bookings.php'>
        <button class="btn btn-success-outline" type="submit">All Bookings</button></a>
    </div>

  <div class="pull-xs-right">
      <a href ='admin_messages.php'>
        <button class="btn btn-success-outline" type="submit">Messages</button></a>
    </div>
